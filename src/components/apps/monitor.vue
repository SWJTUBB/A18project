    ...
    <b-col>
      <b-row>
        <b-col md="3">
                ...
                <b-col md="3">
                  <b-card :title="phValueData" sub-title="PH值" class="wCard3">
                    <div class="card-content">
                ...
                <b-col md="3">
                  <b-card :title="soilTempData" sub-title="土壤温度" class="wCard5">
                    <div class="card-content">
                      <v-chart :options="options_6" class="card-chart" autoresize />
                    </div>
                  </b-card>
                </b-col>
                ...
                <!-- Soil Humidity Card -->
                <b-col md="3">
                  <b-card :title="soilHumiData" sub-title="土壤湿度" class="wCard6">
                    <div class="card-content">
                      <v-chart :options="options_7" class="card-chart" autoresize />
                    </div>
                  </b-card>
                </b-col>
        
                <!-- CO2 Concentration Card -->
                <b-col md="3">
                  <b-card :title="co2Data" sub-title="二氧化碳浓度" class="wCard7">
                    <div class="card-content">
                      <v-chart :options="options_8" class="card-chart" autoresize />
                    </div>
                  </b-card>
                </b-col>
                ...
                <!-- pH Value Card -->
                <b-col md="3">
                  <b-card :title="usedMem" sub-title="使用内存" class="wCard8">
                    <div class="card-content">
                      <v-chart :options="options_9" class="card-chart" autoresize />
                    </div>
                  </b-card>
                </b-col>
              </b-row>
...
.wCard8 {
  background: linear-gradient(45deg, #03a9f4 0%, #0288d1 100%);
}
</style>
